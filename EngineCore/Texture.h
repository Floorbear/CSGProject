...
public:
	...
	static Texture* create_texture(EnginePath& _path);
	...
	static unsigned char* load_resouce(EnginePath& _path, ivec3* _return_size);//_return_size에 텍스처의 width, height, 채널이 리턴됨
private:
