...
SelectionPixelObjectInfo::SelectionPixelObjectInfo(Model* model_id_, CSGNode* mesh_id_) : model_id(model_id_), mesh_id(mesh_id_){
}

bool SelectionPixelObjectInfo::empty(){
    return model_id == nullptr || mesh_id == nullptr;
}
